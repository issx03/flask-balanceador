...
- Define un grupo de servidores backend (en nuestro caso `web1`, `web2` y `web3`) bajo un nombre común (`flask_servers`).

- Esto permite a NGINX distribuir el tráfico entrante entre ellos usando algoritmos de balanceo como Round Robin.
